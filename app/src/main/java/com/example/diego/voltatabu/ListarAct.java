...
import static android.support.design.R.attr.actionModeCloseDrawable;
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                alunos.setHorario(obj.getString("title"));
                                alunos.setNome(obj.getString("rating"));
                                alunos.setUri(obj.getString("image"));
